            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="genre.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: genreInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="genre.games.label" default="Games" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${genreInstance.games}" var="g">
