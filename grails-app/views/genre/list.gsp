                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'genre.id.label', default: 'Id')}" />
                    ...
                    <g:each in="${genreInstanceList}" status="i" var="genreInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${genreInstance.id}">${fieldValue(bean: genreInstance, field: "id")}</g:link></td>
