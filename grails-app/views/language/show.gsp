...
<%@ page import="de.arturh.wiidb.Language" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="language.code.label" default="Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: languageInstance, field: "code")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="language.games.label" default="Games" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${languageInstance.games}" var="g">
