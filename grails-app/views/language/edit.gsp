                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: languageInstance, field: 'code', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="games"><g:message code="language.games.label" default="Games" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: languageInstance, field: 'games', 'errors')}">
