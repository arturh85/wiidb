    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${gameCollectionInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="games"><g:message code="gameCollection.games.label" default="Games" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: gameCollectionInstance, field: 'games', 'errors')}">
                                    <g:select name="games" from="${de.arturh.wiidb.Game.list()}" multiple="yes" optionKey="id" size="5" value="${gameCollectionInstance?.games}" />
                                </td>
                            </tr>
